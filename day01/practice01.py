...
"""
This follow code that you must add
"""
# 100
...
# print(f'一共需要找{total_amount}元, {hundred_amount}张100元纸币, {fifty_amount}张50元纸币, {twenty_amount}张20元纸币, '
    #   f'{ten_amount}张10元纸币, {five_amount}张5元纸币, {two_amount}张2元纸币, {one_amount}张1元纸币')
